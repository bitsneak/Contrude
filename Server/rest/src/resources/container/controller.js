...
export const getContainerById = tryCatchWrapper(async function (req, res, next) {
    ...
    const sql = "SELECT c.serial_number, c.check_digit, c.csc, c.equipment_identifier, c.overhead_electrical_danger_warning, c.repair_recommendation FROM container.container c WHERE c.id = ? LIMIT 1";
